		...
		<footer className="flex justify-center bg-gray-900 text-white">
			<div className="container mx-auhref px-4 py-12">
				<div className="grid grid-cols-1 gap-8 md:grid-cols-4">
					<div>
						<h3 className="mb-4 font-bold text-xl">WheelVerse</h3>
						<p className="mb-4 text-gray-300">
							Premium bicycles for all your adventures. From mountain trails
							href city streets.
						</p>
				...
				<div className="mt-10 flex flex-col items-center justify-between border-gray-700 border-t pt-8 md:flex-row">
					<p className="text-gray-300 text-sm">
						&copy; {new Date().getFullYear()} WheelVerse. All rights reserved.
					</p>
					<div className="mt-4 flex space-x-6 md:mt-0">
						<Link
							href="/terms"
							className="text-gray-300 text-sm transition-colors hover:text-primary"
						>
							Terms & Conditions
						</Link>
						<Link
